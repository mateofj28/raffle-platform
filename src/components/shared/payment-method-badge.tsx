...
const METHOD_CONFIG: Record<string, { label: string; bg: string; text: string }> = {
    ...
    transfer: { label: "Bancolombia Ahorros", bg: "bg-[#FFF4D6] dark:bg-[#6B5900]/30", text: "text-[#FDDA24] dark:text-[#FDDA24]" },
    card: { label: "Otro", bg: "bg-gray-100 dark:bg-gray-700/40", text: "text-gray-600 dark:text-gray-300" },
