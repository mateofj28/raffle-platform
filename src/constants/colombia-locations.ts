...
export const COLOMBIA_DEPARTMENTS: Record<string, string[]> = {
  ...
  Caldas: ["Manizales", "Villamaría", "La Dorada", "Chinchiná", "Riosucio", "Anserma", "Supía", "Neira", "Palestina", "Viterbo", "Aguadas", "Pácora", "Salamina", "Pensilvania", "Manzanares", "Marquetalia"],
  ...
  Quindío: ["Armenia", "Calarcá", "Montenegro", "La Tebaida", "Circasia", "Salento", "Quimbaya", "Filandia", "Córdoba", "Buenavista", "Pijao", "Génova"],
  Risaralda: ["Pereira", "Dosquebradas", "Santa Rosa de Cabal", "La Virginia", "Marsella", "Belén de Umbría", "Quinchía", "Mistrató", "Pueblo Rico", "Guática", "La Celia", "Balboa", "Santuario", "Apía"],
